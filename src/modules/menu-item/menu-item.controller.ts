...
export class MenuItemController {
  ...
  private async executeRoute(
    ...
    params?: IdParamDto | CreateMenuItemDto,
    ...
    switch (operation) {
      ...
      case 'updateMenuItem':
        return this.menuItemService.updateMenuItem(params as IdParamDto, body);
      case 'deleteMenuItem':
  ...
  async getMenuItem(@Param() params: IdParamDto): Promise<MenuItemResponseDto> {
    return this.executeRoute(
      'getMenuItem',
      params,
    ) as Promise<MenuItemResponseDto>;
  }
  ...
  async updateMenuItem(
    ...
    @Body() updateDto: CreateMenuItemDto,
  ): Promise<MenuItemResponseDto> {
    return this.executeRoute(
      'updateMenuItem',
      params,

...
export class StaffController {
  ...
  private async executeRoute(
    ...
    params?: IdParamDto | CreateStaffDto,
    body?: CreateStaffDto,
  ) {
    switch (operation) {
      case 'getAll':
      ...
      case 'updateStaff':
        return this.staffService.updateStaff(params as IdParamDto, body);
      case 'deleteStaff':
  ...
  async createStaff(
    ...
    return this.staffService.createStaff(createDto);
  }
  ...
  async updateStaff(
    ...
    @Body() updateDto: CreateStaffDto,
  ): Promise<StaffResponseDto> {
    return this.executeRoute(
      'updateStaff',
      params,
      updateDto,
    ) as Promise<StaffResponseDto>;
  }

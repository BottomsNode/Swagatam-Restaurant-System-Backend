...
export class TableController {
  ...
  private async executeRoute(
    operation:
      ...
      | 'updateTable'
      | 'deleteTable',
    params?: IdParamDto | CreateTableDto,
    body?: CreateTableDto,
  ) {
    switch (operation) {
      case 'getAll':
      ...
      case 'updateTable':
        return this.tableService.updateTable(params as IdParamDto, body);
      case 'deleteTable':
  ...
  async updateTable(
    ...
    @Body() updateDto: CreateTableDto,
  ): Promise<TableResponseDto> {
    return this.executeRoute(
      'updateTable',
      params,
      updateDto,
    ) as Promise<TableResponseDto>;
  }
